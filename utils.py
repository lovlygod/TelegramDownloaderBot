...
async def upload(m, bot, chat_id, dir):
    ...
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
					InlineKeyboardButton("👨🏼‍💻Developer", url='https://t.me/lovlyswag'),
					InlineKeyboardButton("🤖Other Bots", url="https://t.me/lovlydev/12")
				],
				[
					InlineKeyboardButton("🔗Source Code", url="https://github.com/lovlygod"),
                    InlineKeyboardButton("⚡️Update Channel", url="https://t.me/lovlydev")
				]
			]
			)
		)
